...
const ReservedGifts = () => {
  ...
  useEffect(() => {
    ...
    const channel = supabase
      .channel("reserved_gifts_realtime")
      .on(
        "postgres_changes",
  ...
  return (
    <div className="container mx-auto p-4 md:p-8">
      ...
      <main>
        <h2 className="text-3xl font-semibold mb-6 text-center">Presentes Reservados</h2>
        {loading ? (
          ...
          <p className="text-center text-muted-foreground">Nenhum presente reservado no momento.</p>
        )}
      </main>
    </div>
  );
